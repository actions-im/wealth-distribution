...
Run `uv sync`, `uv run pytest -q`, and `uvx ruff check Home.py pages src scripts tests` before submitting a pull request. New behavior requires a failing test first.
